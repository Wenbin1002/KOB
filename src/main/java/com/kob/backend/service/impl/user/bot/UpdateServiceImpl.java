...
public class UpdateServiceImpl implements UpdateService {
    ...
    public Map<String, String> update(Map<String, String> data) {
        ...
        UserDetailsImpl loinUser = (UserDetailsImpl) authenticationToken.getPrincipal();
        User user = loinUser.getUser();
        ...
        if(description.length() > 300) {
            map.put("error_message", "description should less than 300");
            return map;
        }
